...
Shared cognitive substrate - memory, knowledge, and episodic state that agents read, write, and reason over beyond
...
governed reference data, session scratchpads, and ordered decision history suitable for replay.
