...
Closing the loop from outcomes back into routing, policy, or agent behavior under governance. Patterns here fold
measured results into selection weights, compare intent to reality, and propose bounded improvements that humans can
